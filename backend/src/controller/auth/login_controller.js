...
const login_controller = {
    async login (req, res, next) {
        ...
        try {
            ...
            const {user_name, status, email, mobile_number, _id, role} = user
            ...
            res.json({ data:{access_token, refresh_token, userData: {user_name, status, email, mobile_number, id: _id, role}}, status: true, statusCode: 200, message: "User Login Succesfully" });
